...
class Product7SupabaseUser extends BaseAuthUser {
  Product7SupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> product7SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = Product7SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
